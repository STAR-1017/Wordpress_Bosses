    ...
    <section id="mainimg" class="next service">
        <div class="inner">
            <h1 class="catch">SERVICE<span>スマートフォン(iOS Android)アプリ開発</span></h1>
        </div>
    </section>
    <main class="next">
        <ul class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            ...
            <!--  -->
            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><strong itemprop="name">スマートフォン(iOS Android)アプリ開発</strong>
        ...
        <section id="service-detail" class="container">
            ...
            <section class="features">
                <h2 class="heading-lv01">FEATURES<span>スマートフォン(iOS Android)アプリ開発の特徴</span></h2>
                <div class="features-list">
                    <div class="features-box">
                        <div class="item-img">
                            <div class="bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/service_img/app_1.jpg)"></div>
                        </div>
                        <div class="item-txt">
                            <div class="txt-inner">
                                <h3 class="heading-lv04">スマートフォン(iOS・ Android)アプリ開発</h3>
                                <p>マッチングアプリやゲームアプリなど様々なアプリの開発が可能です。 またブロックチェーンを活用したアプリ開発も可能です。
                                </p>
                            </div>
                        </div>
                    </div>
